...
ArmNoneEabiWizard.cbplugin for Windows in repository is compiled by MinGW TDM-GCC with wxWidgets and Code::Blocks SDK. cbWinRelease branch is built for Code::Blocks Release for Windows. cbReleaseCentOS-i686 branch is built for Code::Blocks Release for Linux CentOS i686. Keep source code for project only in master branch.
...
3, Please download Code::Blocks source code, to produce Code::Blocks SDK and Code::Blocks with SDK in step 2.
4, Please download Arm none eabi Wizard Plugin source code, to be compiled in Code::Blocks with SDK from step 2 and 3 under "Win32 Release" or "Win32 Debug" Build targer.
...
4, Please download Arm none eabi Wizard Plugin source code, to be compiled in Code::Blocks under "Linux Release" or "Linux default" Build targer.
...
仓库上的 Windows 版 ArmNoneEabiWizard.cbplugin 基于 wxWidgets 和 Code::Blocks SDK 由 MinGW TDM-GCC 编译生成。cbWinRelease 分支适用于 Code::Blocks Release for Windows 版本。cbReleaseCentOS-i686 分支适用于 Code::Blocks Release for Linux CentOS i686 版本。master 分支只保留用于项目构建的源代码。
...
3，请下载 Code::Blocks 源代码，用步骤2生成的动态链接库SDK编译生成 Code::Blocks SDK 和 Code::Blocks。
4，请从上述代码仓库上下载 Arm none eabi Wizard Plugin 源代码。用步骤2和3生成的SDK在 Code::Blocks 使用 "Win32 Release" 或 "Win32 Debug" Build targer 编译。
